...
class HAMER(pl.LightningModule):
    ...
    def __init__(self, cfg: CfgNode, init_renderer: bool = True):
        ...
        self.mano_head = self.mano_head.half()
    ...
    def forward_step(self, batch: Dict, train: bool = False) -> Dict:
        ...
        focal_length = batch['focal'] * torch.ones(batch_size, 2, device=device, dtype=dtype)
        ...
        mano_output = self.mano(**{k: v.half() for k,v in pred_mano_params.items()}, pose2rot=False)
